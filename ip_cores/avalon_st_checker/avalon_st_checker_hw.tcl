...
# Wed Oct 20 20:23:17 CEST 2021
# DO NOT MODIFY


# 
# avalon_st_checker "Avalon-Stream Checker" v1.0
#  2021.10.20.20:23:17
# 
# 
...
set_module_property NAME avalon_st_checker
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME "Avalon-Stream Checker"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL avalon_st_checker
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file avalon_st_checker.sv SYSTEM_VERILOG PATH hdl/avalon_st_checker.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL avalon_st_checker
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file avalon_st_checker.sv SYSTEM_VERILOG PATH hdl/avalon_st_checker.sv
...
add_interface_port data asi_data_data data Input DATA_W
add_interface_port data asi_data_valid valid Input 1
